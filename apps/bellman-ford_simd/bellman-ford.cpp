		...
		unsigned *graph_degrees)
{
	...
	for (unsigned edge_i = 0; edge_i < bound_edge_i; edge_i += NUM_P_INT) {
		...
		__m512i dist_n1_v = _mm512_i32gather_epi32(n1_v, dist, sizeof(unsigned));
		__m512i dist_n2_v = _mm512_i32gather_epi32(n2_v, dist, sizeof(unsigned));
		__m512i dist_tmp_v = _mm512_add_epi32(dist_n1_v, _mm512_set1_epi32(1));
		__mmask16 is_less_m = _mm512_cmplt_epi32_mask(dist_tmp_v, dist_n2_v);
		if (is_less_m) {
			_mm512_mask_i32scatter_epi32(dist, is_less_m, n2_v, dist_tmp_v, sizeof(unsigned));	
		}
	...
	if (remainder > 0) {
		...
		__m512i dist_n1_v = _mm512_mask_i32gather_epi32(_mm512_undefined_epi32(), in_range_m, n1_v, dist, sizeof(unsigned));
		__m512i dist_n2_v = _mm512_mask_i32gather_epi32(_mm512_undefined_epi32(), in_range_m, n2_v, dist, sizeof(unsigned));
		__m512i dist_tmp_v = _mm512_mask_add_epi32(_mm512_undefined_epi32(), in_range_m, dist_n1_v, _mm512_set1_epi32(1));
		__mmask16 is_less_m = _mm512_mask_cmplt_epi32_mask(in_range_m, dist_tmp_v, dist_n2_v);
		if (is_less_m) {
			_mm512_mask_i32scatter_epi32(dist, is_less_m, n2_v, dist_tmp_v, sizeof(unsigned));	
		}
		...
		unsigned side_length)
{
	...
	//unsigned row_index;
	unsigned *dist = (unsigned *) malloc(NNODES * sizeof(unsigned));
