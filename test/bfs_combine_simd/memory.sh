...
#data_file="soc-pokec"
data_addr="/home/zpeng/benchmarks/data/twt_col"
...
version=col-simd-bfs-mcdram
report_dir="report_${version}_${data_file}_$(date +%Y%m%d-%H%M%S)"
amplxe-cl -collect memory-access -result-dir ${report_dir} -data-limit=0 -knob analyze-mem-objects=true -knob analyze-openmp=true -- numactl -m 1 ./bfs ${data_addr}/${data_file} 4096 256
amplxe-cl -report summary -result-dir ${report_dir} -format text -report-output ${report_dir}/write.txt
mv timeline.txt ${report_dir}/
echo done.
