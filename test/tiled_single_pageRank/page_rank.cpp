...
//	//}
//	unsigned num_tiles;
//	if (nnodes % tile_side_length) {
//		num_tiles = nnodes / tile_side_length + 1;
//	} else {
//		num_tiles = nnodes / tile_side_length;
//	}
...
//		//unsigned tile_id = n2 / tile_side_length;
...
void input(char filename[]) {
	...
	if (nnodes % tile_side_length) {
		side_length = nnodes / tile_side_length + 1;
	} else {
		side_length = nnodes / tile_side_length;
	}
	num_tiles = side_length * side_length;
	//unsigned max_top = tile_side_length * tile_side_length * 2;
	unsigned max_top = nedges / num_tiles * 4;
	unsigned **tiles_n1 = (unsigned **) malloc(num_tiles * sizeof(unsigned *));
	unsigned **tiles_n2 = (unsigned **) malloc(num_tiles * sizeof(unsigned *));
	for (unsigned i = 0; i < num_tiles; ++i) {
		tiles_n1[i] = (unsigned *) malloc(max_top * sizeof(unsigned));
	...
	for (unsigned i = 0; i < nedges; ++i) {
		...
		unsigned n2;
		fscanf(fin, "%u %u", &n1, &n2);
		//unsigned n1_id = n1 / tile_side_length;
		//unsigned n2_id = n2 / tile_side_length;
