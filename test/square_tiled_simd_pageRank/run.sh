...
#	size=$((2 ** power))
#done
#(set -x; ${bin_addr}/page_rank ${data_addr}/${data_file} ${size} 1024 4096 >> $result_file)
(set -x; numactl -m 1 ${bin_addr}/page_rank ${data_addr}/${data_file} ${size} 1024 4096 >> $result_file)
echo done.
