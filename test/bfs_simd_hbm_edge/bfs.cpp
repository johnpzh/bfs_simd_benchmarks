		...
		int *is_updating_active_side)
{
	...
	unsigned *heads_buffer = nullptr;
	unsigned *tails_buffer = nullptr;
	hbw_posix_memalign((void **) &heads_buffer, ALIGNED_BYTES, sizeof(unsigned) * SIZE_BUFFER_MAX * NUM_THREADS);
	hbw_posix_memalign((void **) &tails_buffer, ALIGNED_BYTES, sizeof(unsigned) * SIZE_BUFFER_MAX * NUM_THREADS);
...
#pragma omp parallel num_threads(NUM_THREADS) private(fname, fin)
{
	...
	graph_edges = (unsigned *) hbw_malloc(sizeof(unsigned) * NEDGES);
