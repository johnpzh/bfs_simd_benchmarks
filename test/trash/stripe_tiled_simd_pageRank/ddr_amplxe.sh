...
version=stripe-simd-pageRank-ddr
...
#	amplxe-cl -collect memory-access -result-dir ${report_dir} -quiet -- ./bfs $size ${data_addr}/${data_file} 256 32768
#	amplxe-cl -report summary -result-dir ${report_dir} -format text -report-output ${report_dir}/write.txt
#	echo -n .
#done
amplxe-cl -collect memory-access -result-dir ${report_dir_prefix} -quiet -- ./page_rank ${data_addr}/${data_file} 1 32 > ${report_dir_prefix}_time-line.txt
